...
namespace dt.HsCode.Database.Migrations
{
    ...
    [Migration("20180716191913_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("dt.HsCode.Model.HsCode.Category", b =>
                {
                    ...
                    b.ToTable("Categories","HsCode");
                });

            modelBuilder.Entity("dt.HsCode.Model.HsCode.Chapter", b =>
                {
                    b.Property<int>("ChapterId")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("Chapters","HsCode");
                });

            modelBuilder.Entity("dt.HsCode.Model.HsCode.SubCategory", b =>
                {
            ...
            modelBuilder.Entity("dt.HsCode.Model.Lookup.Currency", b =>
                {
                    ...
                    b.HasData(
                        new { Iso = "EUR", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 566, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Euro", CurrencyNumericCode = "978", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "€", SymbolAfterPrice = true },
                        new { Iso = "USD", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "United States dollar", CurrencyNumericCode = "840", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "$", SymbolAfterPrice = false },
                        new { Iso = "GBP", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Pound sterling", CurrencyNumericCode = "826", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "£", SymbolAfterPrice = false },
                        new { Iso = "AUD", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Australian dollar", CurrencyNumericCode = "36", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "AU$", SymbolAfterPrice = false },
                        new { Iso = "BGN", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Bulgarian lev", CurrencyNumericCode = "975", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "лв", SymbolAfterPrice = true },
                        new { Iso = "CAD", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Canadian dollar", CurrencyNumericCode = "124", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "CA$", SymbolAfterPrice = false },
                        new { Iso = "CHF", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Swiss franc", CurrencyNumericCode = "756", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "CHF", SymbolAfterPrice = false },
                        new { Iso = "CZK", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Czech koruna", CurrencyNumericCode = "203", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "Kč", SymbolAfterPrice = true },
                        new { Iso = "DKK", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Danish krone", CurrencyNumericCode = "208", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "kr", SymbolAfterPrice = false },
                        new { Iso = "ZAR", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "South African rand", CurrencyNumericCode = "710", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "R", SymbolAfterPrice = false },
                        new { Iso = "HUF", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Hungarian forint", CurrencyNumericCode = "348", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "Ft", SymbolAfterPrice = true },
                        new { Iso = "LTL", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Lithuanian litas", CurrencyNumericCode = "440", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "Lt", SymbolAfterPrice = false },
                        new { Iso = "LVL", Active = false, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Latvian lats", CurrencyNumericCode = "428", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "Ls", SymbolAfterPrice = false },
                        new { Iso = "NOK", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Norwegian krone", CurrencyNumericCode = "578", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "kr", SymbolAfterPrice = false },
                        new { Iso = "NZD", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "New Zealand dollar", CurrencyNumericCode = "554", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "NZ$", SymbolAfterPrice = false },
                        new { Iso = "PLN", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Polish zloty", CurrencyNumericCode = "985", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "zł", SymbolAfterPrice = true },
                        new { Iso = "QAR", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Qatari riyal", CurrencyNumericCode = "634", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "ر.ق", SymbolAfterPrice = true },
                        new { Iso = "RON", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Romanian new leu", CurrencyNumericCode = "946", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "lei", SymbolAfterPrice = true },
                        new { Iso = "SAR", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Saudi riyal", CurrencyNumericCode = "682", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "ر.س", SymbolAfterPrice = true },
                        new { Iso = "SEK", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Swedish krona/kronor", CurrencyNumericCode = "752", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "kr", SymbolAfterPrice = false },
                        new { Iso = "AED", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "United Arab Emirates dirham", CurrencyNumericCode = "784", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "د.إ", SymbolAfterPrice = true },
                        new { Iso = "ARS", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Argentine peso", CurrencyNumericCode = "32", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "$", SymbolAfterPrice = false },
                        new { Iso = "AZN", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Azerbaijani manat", CurrencyNumericCode = "944", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "ман", SymbolAfterPrice = false },
                        new { Iso = "BBD", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Barbados dollar", CurrencyNumericCode = "52", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "$", SymbolAfterPrice = false },
                        new { Iso = "BDT", Active = false, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Bangladeshi taka", CurrencyNumericCode = "50", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "Tk", SymbolAfterPrice = false },
                        new { Iso = "BHD", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Bahraini dinar", CurrencyNumericCode = "48", Exponent = 3, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = ".د.ب", SymbolAfterPrice = true },
                        new { Iso = "BMD", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Bermudian dollar", CurrencyNumericCode = "60", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "Bd$", SymbolAfterPrice = false },
                        new { Iso = "BOB", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Boliviano", CurrencyNumericCode = "68", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "$b", SymbolAfterPrice = false },
                        new { Iso = "BRL", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Brazilian real", CurrencyNumericCode = "986", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "R$", SymbolAfterPrice = false },
                        new { Iso = "BYR", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Belarusian ruble", CurrencyNumericCode = "974", Exponent = 0, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "BR", SymbolAfterPrice = true },
                        new { Iso = "BZD", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Belize dollar", CurrencyNumericCode = "84", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "BZ$", SymbolAfterPrice = false },
                        new { Iso = "CLP", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Chilean peso", CurrencyNumericCode = "152", Exponent = 0, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "Ch$", SymbolAfterPrice = false },
                        new { Iso = "CNY", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Chinese yuan", CurrencyNumericCode = "156", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "Y", SymbolAfterPrice = false },
                        ...
                        new { Iso = "CRC", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Costa Rican colon", CurrencyNumericCode = "188", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "₡", SymbolAfterPrice = false },
                        new { Iso = "DOP", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Dominican peso", CurrencyNumericCode = "214", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "RD$", SymbolAfterPrice = false },
                        new { Iso = "EGP", Active = false, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Egyptian pound", CurrencyNumericCode = "818", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "£E", SymbolAfterPrice = false },
                        new { Iso = "GTQ", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Guatemalan quetzal", CurrencyNumericCode = "320", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "Q", SymbolAfterPrice = false },
                        new { Iso = "HKD", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Hong Kong dollar", CurrencyNumericCode = "344", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "HK$", SymbolAfterPrice = false },
                        new { Iso = "HNL", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Honduran lempira", CurrencyNumericCode = "340", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "L", SymbolAfterPrice = false },
                        new { Iso = "HRK", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Croatian kuna", CurrencyNumericCode = "191", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "kn", SymbolAfterPrice = true },
                        new { Iso = "IDR", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Indonesian rupiah", CurrencyNumericCode = "360", Exponent = 0, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "Rp", SymbolAfterPrice = false },
                        new { Iso = "ILS", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Israeli new shekel", CurrencyNumericCode = "376", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "NIS", SymbolAfterPrice = false },
                        ...
                        new { Iso = "JMD", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Jamaican dollar", CurrencyNumericCode = "388", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "J$", SymbolAfterPrice = false },
                        new { Iso = "JOD", Active = false, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Jordanian dinar", CurrencyNumericCode = "400", Exponent = 3, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "JD", SymbolAfterPrice = false },
                        new { Iso = "JPY", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Japanese yen", CurrencyNumericCode = "392", Exponent = 0, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "¥", SymbolAfterPrice = false },
                        new { Iso = "KHR", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Cambodian riel", CurrencyNumericCode = "116", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "CR", SymbolAfterPrice = false },
                        new { Iso = "KRW", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "South Korean won", CurrencyNumericCode = "410", Exponent = 0, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "W", SymbolAfterPrice = false },
                        new { Iso = "KWD", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Kuwaiti dinar", CurrencyNumericCode = "414", Exponent = 3, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "د.ك", SymbolAfterPrice = true },
                        new { Iso = "KZT", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Kazakhstani tenge", CurrencyNumericCode = "398", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "KZT", SymbolAfterPrice = false },
                        new { Iso = "LKR", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Sri Lankan rupee", CurrencyNumericCode = "144", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "SLRs", SymbolAfterPrice = false },
                        new { Iso = "MDL", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Moldovan leu", CurrencyNumericCode = "498", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "MDL", SymbolAfterPrice = false },
                        new { Iso = "MVR", Active = false, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Maldivian rufiyaa", CurrencyNumericCode = "462", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "Rf", SymbolAfterPrice = false },
                        new { Iso = "MXN", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Mexican peso", CurrencyNumericCode = "484", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "Mex$", SymbolAfterPrice = false },
                        ...
                        new { Iso = "NIO", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Nicaraguan córdoba", CurrencyNumericCode = "558", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "C$", SymbolAfterPrice = false },
                        new { Iso = "OMR", Active = false, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Omani rial", CurrencyNumericCode = "512", Exponent = 3, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "RO", SymbolAfterPrice = false },
                        new { Iso = "PAB", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Panamanian balboa", CurrencyNumericCode = "590", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "B", SymbolAfterPrice = false },
                        new { Iso = "PEN", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Peruvian nuevo sol", CurrencyNumericCode = "604", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "S/.", SymbolAfterPrice = false },
                        new { Iso = "PHP", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Philippine peso", CurrencyNumericCode = "608", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "₱", SymbolAfterPrice = false },
                        new { Iso = "PKR", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Pakistani rupee", CurrencyNumericCode = "586", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "Rs", SymbolAfterPrice = false },
                        new { Iso = "PYG", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Paraguayan guaraní", CurrencyNumericCode = "600", Exponent = 0, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "Gs", SymbolAfterPrice = false },
                        new { Iso = "RUB", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Russian ruble", CurrencyNumericCode = "643", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "руб", SymbolAfterPrice = false },
                        new { Iso = "SGD", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Singapore dollar", CurrencyNumericCode = "702", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "$", SymbolAfterPrice = false },
                        new { Iso = "THB", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Thai baht", CurrencyNumericCode = "764", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "฿", SymbolAfterPrice = false },
                        new { Iso = "TRY", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Turkish lira", CurrencyNumericCode = "949", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "TL", SymbolAfterPrice = false },
                        new { Iso = "TWD", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "New Taiwan dollar", CurrencyNumericCode = "901", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "NT$", SymbolAfterPrice = false },
                        new { Iso = "UAH", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Ukrainian hryvnia", CurrencyNumericCode = "980", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "₴", SymbolAfterPrice = false },
                        new { Iso = "VEF", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Venezuelan bolívar", CurrencyNumericCode = "937", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "Bs.", SymbolAfterPrice = false },
                        new { Iso = "GIP", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Gibraltar pound", CurrencyNumericCode = "292", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "£", SymbolAfterPrice = false },
                        new { Iso = "ROL", Active = true, CreationTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), CreationUser = "Seed", CurrencyName = "Romanian leu", CurrencyNumericCode = "642", Exponent = 2, LastUpdateTime = new DateTime(2018, 7, 16, 20, 19, 12, 567, DateTimeKind.Local), LastUpdateUser = "Seed", NonNullableDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Symbol = "lei", SymbolAfterPrice = false }
                    );
                });

            modelBuilder.Entity("dt.HsCode.Model.HsCode.Category", b =>
                {
                    b.HasOne("dt.HsCode.Model.HsCode.Chapter", "Chapter")
                        .WithMany()
            ...
            modelBuilder.Entity("dt.HsCode.Model.HsCode.SubCategory", b =>
                {
                    b.HasOne("dt.HsCode.Model.HsCode.Category", "Category")
                        .WithMany()
